...
- [Установка](#установка)
- [Настройка](#настройка)
  - [Автоматическая настройка с использованием init.sh __`начните с этого`__](#автоматическая-настройка-с-использованием-initsh)
  - [Настройка в ручном режиме __`для лучшего понимания`__](#настройка-в-ручном-режиме)
