...
- [Установка](#установка)
- [Настройка](#настройка)
  - [__`:+1:`__ Автоматическая настройка с использованием init.sh](#автоматическая-настройка-с-использованием-initsh)
  - [__`!`__ Настройка в ручном режиме](#настройка-в-ручном-режиме)
